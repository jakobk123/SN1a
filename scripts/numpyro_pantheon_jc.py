# -*- coding: utf-8 -*-
"""
Created on Mon Jun 27 17:19:33 2022
...
def model_lcdm_large_planck(x, y, cov):
    cosm = cosmo(0.7, x)
    Omega_m = sample("Omega_m", dist.TruncatedNormal(0.3166,3*0.0084, low=0, high=1))
    theta_dict = {"Omega_m":Omega_m}
    mu = cosm.dist_mod(theta_dict)
...
init_dict = {'init_0':{'Omega_m':0.5, 'w_0':0., 'w_1':1.}, 'init_1':{'Omega_m':0.3, 'w_0':-1., 'w_1':0.}}
...
results_dir='./numpyro_jc_results/'
    ...
    for j in ['init_0', 'init_1']:
        try:
            run_svi_manual(model_dict,i, x, y, cov, init_dict, j, 
                           num_samples, stepsize, grad_steps, intermediate_steps, results_dir=results_dir, s=10)
